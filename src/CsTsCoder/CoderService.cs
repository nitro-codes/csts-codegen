...
namespace CsTsCoder
{
    public class CoderService
    {
        ...
        public CoderService(LogAction log)
        {
        ...
        public bool Execute()
        {
            Log("Starting CsTsCodegen ConvertService");
            GetInputDirectory();
            GetOutputDirectory();
            LoadModels();
            ...
            Convert();
            Log("Finished CsTsCodegen ConvertService");
            return true;
        }
        ...
        private void GetInputDirectory()
        {
            ...
            var localdir = Path.Combine(dir, InputDirectory);
        ...
        private void GetOutputDirectory()
        {
            ...
            var localdir = Path.Combine(dir, OutputDirectory);
        ...
        private void AddModel(string file, string structure = "")
        {
            ...
            if (!fileInfo.Any(x => x.Contains("[CoderEnabled]")))
                return;
                    ...
                    if (file.IsEnum)
                    {
                        ...
                        foreach (var obj in file.EnumObjects)
                        {
                            ...
                            {  //not an empty obj
                                ...
                                var str = tsName;
                                if (EnumValues == EnumValue.Strings)
                                {
                                    str += " = '" + tsName + "'";
                                }
